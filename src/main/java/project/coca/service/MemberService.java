...
public class MemberService {
    ...
    public MemberService(MemberRepository memberRepository,
                         ...
                         InterestRepository interestRepository, AuthenticationManagerBuilder authenticationManagerBuilder, JwtTokenProvider jwtTokenProvider) {
    ...
    public TokenDto login(MemberFunctionRequest loginMember) {
        ...
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(loginMember.getId(), loginMember.getPassword());
